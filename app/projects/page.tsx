      ...
      <div className="h-full w-full flex flex-col justify-between">
        {CardComponent.length > 0 ? (
          ...
          <div className="w-full flex justify-center items-center mt-4 h-full">
            <Link
              href="/projects/add"
              className="flex justify-center items-center bg-[#FFB158] text-a_black border border-primary_color rounded-full font-bold hover:bg-primary_color px-5 py-2 h-"
            >
              Create a project
            </Link>
          </div>
